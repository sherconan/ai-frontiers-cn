---
title: "Introducing Phi-4: Microsoft's Newest Small Language Model"
description: "微软发布140亿参数的Phi-4小语言模型（SLM），通过高质量合成数据和创新的后训练方法，在数学推理任务上超越了同规模甚至更大规模的模型，标志着\"小而精\"路线的重要里程碑。"
head:
  - - meta
    - property: og:title
      content: "Introducing Phi-4: Microsoft's Newest Small Language Model"
  - - meta
    - property: og:description
      content: "微软发布140亿参数的Phi-4小语言模型（SLM），通过高质量合成数据和创新的后训练方法，在数学推理任务上超越了同规模甚至更大规模的模型，标志着\"小而精\"路线的重要里程碑。"
  - - meta
    - property: og:type
      content: article
---
